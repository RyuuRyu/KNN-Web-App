...
def qr_login():
    ...
    # Accept any QR code generated by qr-generator.py (e.g., user1, user2, etc.)
    allowed_users = ["user1"]  # Add more usernames if you generate more QR codes
    if qr_data in allowed_users:
